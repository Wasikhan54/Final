...
function initSlider(containerId, prevId, nextId, popupId, popupImageId) {
  const carousel = document.getElementById(containerId);
  const slides = carousel.querySelectorAll(".gallery-slider-element");
...
// Initialize sliders for all tabs
initSlider("carousel-website", "go-back-website", "go-forward-website", "popup-website", "popupImage-website");
initSlider("carousel-animation", "go-back-animation", "go-forward-animation", "popup-animation", "popupImage-animation");
initSlider("carousel-app", "go-back-app", "go-forward-app", "popup-app", "popupImage-app");
initSlider("carousel-ecommerce", "go-back-ecommerce", "go-forward-ecommerce", "popup-ecommerce", "popupImage-ecommerce");
initSlider("carousel-logo", "go-back-logo", "go-forward-logo", "popup-logo", "popupImage-logo");
